...
class FriendshipTestCase(TestCase):
    ...
    def test_split_amount_view(self):
        ...
        response = self.c.post(reverse('debt_split_amount'), {'item': 'testitem', 'amount': 10, 'paid_user': self.user.username, 'friends': [self.user.username, friend.username, new_friend.username]})
